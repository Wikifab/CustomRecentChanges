<?php
/**
 * Creates a RCCacheEntry from a RecentChange to use in EnhancedRecentChangesList
 *
...
class RCCacheEntryFactory {
    ...
    public function newFromRecentChange( RecentChange $baseRC, $watched ) {
        ...
        $cacheEntry->unpatrolled = RecentChangesList::isUnpatrolled( $baseRC, $user );
        ...
        if ( !RecentChangesList::isDeleted( $cacheEntry, Revision::DELETED_USER ) ) {
    ...
    private function showDiffLinks( RecentChange $cacheEntry, User $user ) {
        return RecentChangesList::userCan( $cacheEntry, Revision::DELETED_TEXT, $user );
    }
